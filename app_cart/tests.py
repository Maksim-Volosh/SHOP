...
from app_shop.models import Category, ProductProxy

from .views import cart_add, cart_delete, cart_update, cart
...
class CartViewTest(TestCase):
    ...
    def test_cart_view(self):
        ...
        responce = cart(request)
        self.assertEqual(responce.status_code, 200)
        self.assertTemplateUsed(self.client.get(reverse('cart:cart')), 'app_cart/cart.html')
...
class CartAddViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.product = ProductProxy.objects.create(name='Example Product', price=10.0, category=self.category)
